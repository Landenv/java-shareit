    ...
    public ItemDto createItem(ItemCreateDto itemCreateDto, Long ownerId) {
        ...
        if (itemCreateDto.getRequestId() != null) {
            request = itemRequestRepository.findById(itemCreateDto.getRequestId())
                    .orElseThrow(() -> new NotFoundException("Item request not found with id: " + itemCreateDto.getRequestId()));
        }

        Item item = itemMapper.toItemFromCreateDto(itemCreateDto, owner, request);
